...
void GenericDistanceConstraint::constraintFct(const unsigned int numberOfParticles, const Real mass[], const Vector3r x[], void *userData,
...
void GenericDistanceConstraint::gradientFct(const unsigned int i, const unsigned int numberOfParticles, const Real mass[], const Vector3r x[], void *userData,
...
bool GenericDistanceConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr[2];
    const bool res = PositionBasedGenericConstraints::solve_GenericConstraint<2, 1>(invMass, x, &m_restLength, GenericDistanceConstraint::constraintFct,
                                                                                    GenericDistanceConstraint::gradientFct, corr);
...
void GenericIsometricBendingConstraint::constraintFct(const unsigned int numberOfParticles, const Real invMass[], const Vector3r x[], void *userData,
                                                      Eigen::Matrix<Real, 1, 1> &constraintValue)
{
...
bool GenericIsometricBendingConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3,
...
bool GenericIsometricBendingConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedGenericConstraints::solve_GenericConstraint<4, 1>(invMass, x, &m_Q, GenericIsometricBendingConstraint::constraintFct,
...
void
GenericHingeJoint::constraintFct(const unsigned int numberOfRigidBodies, const Real mass[], const Vector3r x[], const Matrix3r inertiaInverseW[], const Quaternionr q[],
                                 void *userData, Eigen::Matrix<Real, 5, 1> &constraintValue)
{
...
void GenericHingeJoint::gradientFct(const unsigned int i, const unsigned int numberOfRigidBodies, const Real mass[], const Vector3r x[], const Matrix3r inertiaInverseW[],
                                    const Quaternionr q[], void *userData, Eigen::Matrix<Real, 5, 6> &jacobian)
{
    Eigen::Matrix<Real, 3, 12> &jointInfo = *(Eigen::Matrix<Real, 3, 12> *) userData;
...
bool GenericHingeJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corrX[2];
    Quaternionr corrQ[2];
    const bool res = PositionBasedGenericConstraints::solve_GenericConstraint<2, 5>(invMass, x, inertiaInverseW, q, &m_jointInfo, GenericHingeJoint::constraintFct,
...
void
GenericBallJoint::constraintFct(const unsigned int numberOfRigidBodies, const Real mass[], const Vector3r x[], const Matrix3r inertiaInverseW[], const Quaternionr q[],
                                void *userData, Eigen::Matrix<Real, 3, 1> &constraintValue)
{
...
bool GenericBallJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corrX[2];
    Quaternionr corrQ[2];
    const bool res = PositionBasedGenericConstraints::solve_GenericConstraint<2, 3>(invMass, x, inertiaInverseW, q, &m_jointInfo, GenericBallJoint::constraintFct, corrX,
                                                                                    corrQ);
...
void
GenericSliderJoint::constraintFct(const unsigned int numberOfRigidBodies, const Real mass[], const Vector3r x[], const Matrix3r inertiaInverseW[], const Quaternionr q[],
                                  void *userData, Eigen::Matrix<Real, 5, 1> &constraintValue)
{
...
bool GenericSliderJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corrX[2];
    Quaternionr corrQ[2];
    const bool res = PositionBasedGenericConstraints::solve_GenericConstraint<2, 5>(invMass, x, inertiaInverseW, q, &m_jointInfo, GenericSliderJoint::constraintFct,
                                                                                    corrX, corrQ);
