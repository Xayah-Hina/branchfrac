...
namespace PBD
{
    ...
    public:
        ...
        static void
        constraintFct(const unsigned int numberOfParticles, const Real invMass[], const Vector3r x[], void *userData, Eigen::Matrix<Real, 1, 1> &constraintValue);

        static void gradientFct(const unsigned int i, const unsigned int numberOfParticles, const Real invMass[], const Vector3r x[], void *userData,
    ...
    public:
        ...
        static void constraintFct(const unsigned int numberOfRigidBodies, const Real invMass[],                    // inverse mass is zero if body is static
                                  const Vector3r x[],                        // positions of bodies
                                  const Matrix3r inertiaInverseW[],        // inverse inertia tensor (world space) of bodies
                                  const Quaternionr q[], void *userData, Eigen::Matrix<Real, 5, 1> &constraintValue);

        static void gradientFct(const unsigned int i, const unsigned int numberOfRigidBodies, const Real invMass[], const Vector3r x[], const Matrix3r inertiaInverseW[],
    ...
    public:
        ...
        static void constraintFct(const unsigned int numberOfRigidBodies, const Real invMass[],                    // inverse mass is zero if body is static
                                  const Vector3r x[],                        // positions of bodies
                                  const Matrix3r inertiaInverseW[],        // inverse inertia tensor (world space) of bodies
                                  const Quaternionr q[], void *userData, Eigen::Matrix<Real, 3, 1> &constraintValue);
