...
void TweakBarParameters::createParameterObjectGUI(ParameterObject *paramObj)
{
    ...
    for (unsigned int i = 0; i < numParams; i++)
    {
        ...
        {
            sprintf(str, " label='%s' help='%s' precision=5 step=0.01 group='%s' %s ", paramBase->getLabel().c_str(), paramBase->getDescription().c_str(),
                    paramBase->getGroup().c_str(), tmp.c_str());
        ...
        {
            sprintf(str, " label='%s' help='%s' step=1 group='%s' %s ", paramBase->getLabel().c_str(), paramBase->getDescription().c_str(), paramBase->getGroup().c_str(),
                    tmp.c_str());
        ...
        } else if (paramBase->getType() == ParameterBase::ENUM)
        {
            ...
            sprintf(str, " label='%s' help='%s' group='%s' %s %s ", paramBase->getLabel().c_str(), paramBase->getDescription().c_str(), paramBase->getGroup().c_str(),
                    tmp.c_str(), enumStr.c_str());
        ...
        {
            sprintf(str, " label='%s' help='%s' group='%s' %s ", paramBase->getLabel().c_str(), paramBase->getDescription().c_str(), paramBase->getGroup().c_str(),
                    tmp.c_str());
