...
void createBunnyRodModel()
{
    ...
    {
        model->addStretchBendingTwistingConstraint(i, i + 1, Vector3r(static_cast<Real>(i) * width + static_cast<Real>(0.5) * width, 0.0, 0.0), 0.25 * (height + depth),
                                                   width, youngsModulus, torsionModulus);
    }
