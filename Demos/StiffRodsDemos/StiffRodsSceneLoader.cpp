...
{
    {
        ...
        for (auto &tm : child)
        {
            ...
            if (tm.find("segmentPositions") != tm.end())
            {
                ...
                {
                    ctmd.m_SegmentPositions.push_back(readVectorValues<Real, 3>(position));
                }
            }
            ...
            if (tm.find("segmentOrientationAxes") != tm.end())
            {
                ...
                {
                    tmpSegmentOrientationAxes.push_back(readVectorValues<Real, 3>(axis));
                }
            }
            ...
            for (size_t idx(0); idx < tmpSegmentOrientationAngles.size() && idx < tmpSegmentOrientationAxes.size(); ++idx)
            {
            ...
            if (tm.find("segmentScales") != tm.end())
            {
                ...
                {
                    ctmd.m_SegmentScales.push_back(readVectorValues<Real, 3>(scale));
                }
            }
            ...
            if (tm.find("jointPositions") != tm.end())
            {
                ...
                {
                    ctmd.m_SBTConstraintPositions.push_back(readVectorValues<Real, 3>(jp));
                }
            }
            ...
            if (tm.find("jointStiffnessModifier") != tm.end())
            {
                ...
                {
                    ctmd.m_SBTConstraintStiffnessModifier.push_back(readVectorValues<Real, 3>(jsm));
                }
            }
        }
    }
