...
//////////////////////////////////////////////////////////////////////////
bool PerpendiculaBisectorConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3)
{
...
bool PerpendiculaBisectorConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr[3];
    const bool res = PositionBasedElasticRods::solve_PerpendiculaBisectorConstraint(x1, invMass1, x2, invMass2, x3, invMass3, 1.0, corr[0], corr[1], corr[2]);
...
//////////////////////////////////////////////////////////////////////////
bool GhostPointEdgeDistanceConstraint::initConstraint(PositionBasedElasticRodsModel &model, const unsigned int particle1, const unsigned int particle2,
...
bool GhostPointEdgeDistanceConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr[3];
    const bool res = PositionBasedElasticRods::solve_GhostPointEdgeDistanceConstraint(x1, invMass1, x2, invMass2, x3, invMass3, 1.0, m_restLength, corr[0], corr[1],
                                                                                      corr[2]);
...
//////////////////////////////////////////////////////////////////////////
bool
DarbouxVectorConstraint::initConstraint(PositionBasedElasticRodsModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3,
                                        const unsigned int particle4, const unsigned int particle5)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
    m_bodies[2] = particle3;
...
bool DarbouxVectorConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    bool res = PositionBasedElasticRods::solve_DarbouxVectorConstraint(x1, invMass1, x2, invMass2, x3, invMass3, x4, invMass4, x5, invMass5,
                                                                       simModel.getBendingAndTwistingStiffness(), 1.0, simModel.getRestDarbouxVector(), corr[0], corr[1],
