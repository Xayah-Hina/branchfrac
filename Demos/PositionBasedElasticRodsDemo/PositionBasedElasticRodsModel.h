...
namespace PBD
{
    ...
    public:
        ...
        void addElasticRodModel(const unsigned int nPoints, Vector3r *points);
        ...
        bool addDarbouxVectorConstraint(const unsigned int pA, const unsigned int pB, const unsigned int pC, const unsigned int pD, const unsigned int pE);
