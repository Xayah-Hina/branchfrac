...
PositionBasedElasticRodsModel::PositionBasedElasticRodsModel() : SimulationModel()
{
    m_stiffness.setOnes();
}
...
bool PositionBasedElasticRodsModel::addDarbouxVectorConstraint(const unsigned int pA, const unsigned int pB, const unsigned int pC, const unsigned int pD,
...
void PBD::PositionBasedElasticRodsModel::addElasticRodModel(const unsigned int nPoints, Vector3r *points)
{
