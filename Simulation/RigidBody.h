...
namespace PBD
{
    ...
    public:
        ...
        void initBody(const Real mass, const Vector3r &x, const Vector3r &inertiaTensor, const Quaternionr &rotation, const VertexData &vertices,
                      const Utilities::IndexedFaceMesh &mesh, const Vector3r &scale = Vector3r(1.0, 1.0, 1.0))
        {
            setMass(mass);
            m_x = x;
            m_x0 = x;
        ...
        void initBody(const Real density, const Vector3r &x, const Quaternionr &rotation, const VertexData &vertices, const Utilities::IndexedFaceMesh &mesh,
        ...
        void determineMassProperties(const Real density)
        {
            ...
            Utilities::VolumeIntegration vi(m_geometry.getVertexDataLocal().size(), m_geometry.getMesh().numFaces(), &m_geometry.getVertexDataLocal().getPosition(0),
