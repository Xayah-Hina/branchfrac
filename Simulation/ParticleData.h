...
//        FORCE_INLINE void exchange(const unsigned int a, const unsigned int b)
//        {
//            Real m_massest = m_masses[a];
//            Real m_invMassest = m_invMasses[a];
//            Vector3r m_x0t = m_x0[a];
//            Vector3r m_xt = m_x[a];
//            Vector3r m_vt = m_v[a];
//            Vector3r m_at = m_a[a];
//            Vector3r m_oldXt = m_oldX[a];
//            Vector3r m_lastXt = m_lastX[a];
//
//            m_masses[a] = m_masses[b];
//            m_invMasses[a] = m_invMasses[b];
//            m_x0[a] = m_x0[b];
//            m_x[a] = m_x[b];
//            m_v[a] = m_v[b];
//            m_a[a] = m_a[b];
...
//            m_lastX[a] = m_lastX[b];
//
//            m_masses[b] = m_massest;
//            m_invMasses[b] = m_invMassest;
//            m_x0[b] = m_x0t;
//            m_x[b] = m_xt;
//            m_v[b] = m_vt;
//            m_a[b] = m_at;
...
//        }
    ...
    */
    ...
    public:
        FORCE_INLINE OrientationData(void) : m_masses(), m_invMasses(), m_q0(), m_q(), m_omega(), m_alpha(), m_oldQ(), m_lastQ()
        {
        }
