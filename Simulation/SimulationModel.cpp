...
bool
SimulationModel::addRigidBodyContactConstraint(const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &cp1, const Vector3r &cp2, const Vector3r &normal,
...
bool SimulationModel::addParticleRigidBodyContactConstraint(const unsigned int particleIndex, const unsigned int rbIndex, const Vector3r &cp1, const Vector3r &cp2,
...
bool
SimulationModel::addParticleSolidContactConstraint(const unsigned int particleIndex, const unsigned int solidIndex, const unsigned int tetIndex, const Vector3r &bary,
                                                   const Vector3r &cp1, const Vector3r &cp2, const Vector3r &normal, const Real dist, const Real restitutionCoeff,
...
bool SimulationModel::addDihedralConstraint(const unsigned int particle1, const unsigned int particle2, const unsigned int particle3, const unsigned int particle4)
{
...
bool
SimulationModel::addIsometricBendingConstraint(const unsigned int particle1, const unsigned int particle2, const unsigned int particle3, const unsigned int particle4)
{
...
bool SimulationModel::addFEMTriangleConstraint(const unsigned int particle1, const unsigned int particle2, const unsigned int particle3)
{
...
bool SimulationModel::addStrainTriangleConstraint(const unsigned int particle1, const unsigned int particle2, const unsigned int particle3)
{
...
bool SimulationModel::addVolumeConstraint(const unsigned int particle1, const unsigned int particle2, const unsigned int particle3, const unsigned int particle4)
{
...
bool SimulationModel::addFEMTetConstraint(const unsigned int particle1, const unsigned int particle2, const unsigned int particle3, const unsigned int particle4)
{
...
bool SimulationModel::addStrainTetConstraint(const unsigned int particle1, const unsigned int particle2, const unsigned int particle3, const unsigned int particle4)
{
...
bool PBD::SimulationModel::addStretchBendingTwistingConstraint(const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Real averageRadius,
                                                               const Real averageSegmentLength, const Real youngsModulus, const Real torsionModulus)
{
    ...
    const bool res = c->initConstraint(*this, rbIndex1, rbIndex2, pos, averageRadius, averageSegmentLength, youngsModulus, torsionModulus);
    if (res)
    {
        m_constraints.push_back(c);
        m_groupsInitialized = false;
...
bool PBD::SimulationModel::addDirectPositionBasedSolverForStiffRodsConstraint(const std::vector<std::pair<unsigned int, unsigned int>> &jointSegmentIndices,
                                                                              const std::vector<Vector3r> &jointPositions, const std::vector<Real> &averageRadii,
                                                                              ...
                                                                              const std::vector<Real> &torsionModuli)
{
    ...
    const bool res = c->initConstraint(*this, jointSegmentIndices, jointPositions, averageRadii, averageSegmentLengths, youngsModuli, torsionModuli);
    if (res)
    {
        m_constraints.push_back(c);
        m_groupsInitialized = false;
...
void SimulationModel::addTriangleModel(const unsigned int nPoints, const unsigned int nFaces, Vector3r *points, unsigned int *indices,
                                       const TriangleModel::ParticleMesh::UVIndices &uvIndices, const TriangleModel::ParticleMesh::UVs &uvs)
{
...
void SimulationModel::addTetModel(const unsigned int nPoints, const unsigned int nTets, Vector3r *points, unsigned int *indices)
{
...
void SimulationModel::addTetModelFromTetModelWithNewTets(TetModel *tm, std::vector<unsigned int> &tets)
{
    TetModel *tetModel = new TetModel();
    tetModel->getParticleMesh().release();
    tetModel->setIndexOffset(tm->getIndexOffset());
    tetModel->getParticleMesh().changetetind(tets);
    tetModel->getParticleMesh().setpointnum(tm->getParticleMesh().numVertices());
    m_tetModels.push_back(tetModel);
}

void SimulationModel::addLineModel(const unsigned int nPoints, const unsigned int nQuaternions, Vector3r *points, Quaternionr *quaternions, unsigned int *indices,
