...
bool BallJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos)
{
    ...
    return PositionBasedRigidBodyDynamics::init_BallJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), pos, m_jointInfo);
}
...
bool BallJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_BallJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool BallJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedRigidBodyDynamics::solve_BallJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                     rb2.getInvMass(), rb2.getPosition(), rb2.getInertiaTensorInverseW(), rb2.getRotation(), m_jointInfo,
                                                                     corr_x1, corr_q1, corr_x2, corr_q2);
...
bool BallOnLineJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &dir)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_BallOnLineJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), pos, dir, m_jointInfo);
}
...
bool BallOnLineJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_BallOnLineJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool BallOnLineJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_BallOnLineJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                           rb2.getInvMass(), rb2.getPosition(), rb2.getInertiaTensorInverseW(), rb2.getRotation(),
                                                                           m_jointInfo, corr_x1, corr_q1, corr_x2, corr_q2);
...
bool HingeJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_HingeJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), pos, axis, m_jointInfo);
}
...
bool HingeJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_HingeJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool HingeJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_HingeJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                      rb2.getInvMass(), rb2.getPosition(), rb2.getInertiaTensorInverseW(), rb2.getRotation(), m_jointInfo,
                                                                      corr_x1, corr_q1, corr_x2, corr_q2);
...
// UniversalJoint
//////////////////////////////////////////////////////////////////////////
bool UniversalJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis1,
                                    const Vector3r &axis2)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_UniversalJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), pos, axis1, axis2,
                                                               m_jointInfo);
}
...
bool UniversalJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_UniversalJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool UniversalJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_UniversalJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                          rb2.getInvMass(), rb2.getPosition(), rb2.getInertiaTensorInverseW(), rb2.getRotation(),
                                                                          m_jointInfo, corr_x1, corr_q1, corr_x2, corr_q2);
...
bool SliderJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &axis)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_SliderJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), axis, m_jointInfo);
}
...
bool SliderJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_SliderJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool SliderJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_SliderJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                       rb2.getInvMass(), rb2.getPosition(), rb2.getInertiaTensorInverseW(), rb2.getRotation(),
                                                                       m_jointInfo, corr_x1, corr_q1, corr_x2, corr_q2);
...
bool TargetPositionMotorSliderJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &axis)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_TargetPositionMotorSliderJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), axis,
                                                                               m_jointInfo);
}
...
bool TargetPositionMotorSliderJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_TargetPositionMotorSliderJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool TargetPositionMotorSliderJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_TargetPositionMotorSliderJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(),
                                                                                          rb1.getRotation(), rb2.getInvMass(), rb2.getPosition(),
                                                                                          rb2.getInertiaTensorInverseW(), rb2.getRotation(), m_target, m_jointInfo,
                                                                                          corr_x1, corr_q1, corr_x2, corr_q2);
...
bool TargetVelocityMotorSliderJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &axis)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_TargetVelocityMotorSliderJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), axis,
                                                                               m_jointInfo);
}
...
bool TargetVelocityMotorSliderJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_TargetVelocityMotorSliderJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool TargetVelocityMotorSliderJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_TargetVelocityMotorSliderJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(),
                                                                                          rb1.getRotation(), rb2.getInvMass(), rb2.getPosition(),
                                                                                          rb2.getInertiaTensorInverseW(), rb2.getRotation(), m_jointInfo, corr_x1,
...
bool TargetVelocityMotorSliderJoint::solveVelocityConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedRigidBodyDynamics::velocitySolve_TargetVelocityMotorSliderJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getVelocity(),
                                                                                                  rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                                                  rb1.getAngularVelocity(), rb2.getInvMass(), rb2.getPosition(),
                                                                                                  rb2.getVelocity(), rb2.getInertiaTensorInverseW(), rb2.getRotation(),
                                                                                                  rb2.getAngularVelocity(), m_target, m_jointInfo, corr_v1, corr_omega1,
                                                                                                  corr_v2, corr_omega2);
...
//////////////////////////////////////////////////////////////////////////
bool
TargetAngleMotorHingeJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    SimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_TargetAngleMotorHingeJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), pos, axis,
                                                                           m_jointInfo);
}
...
bool TargetAngleMotorHingeJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_TargetAngleMotorHingeJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool TargetAngleMotorHingeJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_TargetAngleMotorHingeJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(),
                                                                                      rb1.getRotation(), rb2.getInvMass(), rb2.getPosition(),
                                                                                      rb2.getInertiaTensorInverseW(), rb2.getRotation(), m_target, m_jointInfo, corr_x1,
                                                                                      corr_q1, corr_x2, corr_q2);
...
//////////////////////////////////////////////////////////////////////////
bool
TargetVelocityMotorHingeJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos, const Vector3r &axis)
{
    m_bodies[0] = rbIndex1;
    m_bodies[1] = rbIndex2;
    SimulationModel::RigidBodyVector &rb = model.getRigidBodies();
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_TargetVelocityMotorHingeJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), pos, axis,
                                                                              m_jointInfo);
}
...
bool TargetVelocityMotorHingeJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_TargetVelocityMotorHingeJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool TargetVelocityMotorHingeJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_TargetVelocityMotorHingeJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(),
                                                                                         rb1.getRotation(), rb2.getInvMass(), rb2.getPosition(),
                                                                                         rb2.getInertiaTensorInverseW(), rb2.getRotation(), m_jointInfo, corr_x1, corr_q1,
                                                                                         corr_x2, corr_q2);
...
bool TargetVelocityMotorHingeJoint::solveVelocityConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_v1, corr_v2;
    Vector3r corr_omega1, corr_omega2;
    const bool res = PositionBasedRigidBodyDynamics::velocitySolve_TargetVelocityMotorHingeJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getVelocity(),
                                                                                                 rb1.getInertiaTensorInverseW(), rb1.getAngularVelocity(),
                                                                                                 rb2.getInvMass(), rb2.getPosition(), rb2.getVelocity(),
                                                                                                 rb2.getInertiaTensorInverseW(), rb2.getAngularVelocity(), m_target,
                                                                                                 m_jointInfo, corr_v1, corr_omega1, corr_v2, corr_omega2);
...
bool DamperJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &axis, const Real stiffness)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_DamperJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), axis, m_jointInfo);
}
...
bool DamperJoint::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_DamperJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool DamperJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_DamperJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                       rb2.getInvMass(), rb2.getPosition(), rb2.getInertiaTensorInverseW(), rb2.getRotation(),
                                                                       m_stiffness, dt, m_jointInfo, m_lambda, corr_x1, corr_q1, corr_x2, corr_q2);
...
bool RigidBodyParticleBallJoint::initConstraint(SimulationModel &model, const unsigned int rbIndex, const unsigned int particleIndex)
{
    ...
    return PositionBasedRigidBodyDynamics::init_RigidBodyParticleBallJoint(rb.getPosition(), rb.getRotation(), pd.getPosition(particleIndex), m_jointInfo);
}
...
bool RigidBodyParticleBallJoint::updateConstraint(SimulationModel &model)
{
    ...
    ParticleData &pd = model.getParticles();
    RigidBody &rb1 = *rb[m_bodies[0]];
    return PositionBasedRigidBodyDynamics::update_RigidBodyParticleBallJoint(rb1.getPosition(), rb1.getRotation(), pd.getPosition(m_bodies[1]), m_jointInfo);
}
...
bool RigidBodyParticleBallJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1;
    const bool res = PositionBasedRigidBodyDynamics::solve_RigidBodyParticleBallJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(),
                                                                                      rb1.getRotation(), pd.getInvMass(m_bodies[1]), pd.getPosition(m_bodies[1]),
                                                                                      m_jointInfo, corr_x1, corr_q1, corr_x2);
...
// RigidBodySpring
//////////////////////////////////////////////////////////////////////////
bool RigidBodySpring::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &pos1, const Vector3r &pos2,
                                     const Real stiffness)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::init_DistanceJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), pos1, pos2, m_jointInfo);
}
...
bool RigidBodySpring::updateConstraint(SimulationModel &model)
{
    ...
    RigidBody &rb1 = *rb[m_bodies[0]];
    RigidBody &rb2 = *rb[m_bodies[1]];
    return PositionBasedRigidBodyDynamics::update_DistanceJoint(rb1.getPosition(), rb1.getRotation(), rb2.getPosition(), rb2.getRotation(), m_jointInfo);
}
...
bool RigidBodySpring::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_DistanceJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                         rb2.getInvMass(), rb2.getPosition(), rb2.getInertiaTensorInverseW(), rb2.getRotation(),
                                                                         m_stiffness, m_restLength, dt, m_jointInfo, m_lambda, corr_x1, corr_q1, corr_x2, corr_q2);
...
bool DistanceJoint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Quaternionr corr_q1, corr_q2;
    const bool res = PositionBasedRigidBodyDynamics::solve_DistanceJoint(rb1.getInvMass(), rb1.getPosition(), rb1.getInertiaTensorInverseW(), rb1.getRotation(),
                                                                         rb2.getInvMass(), rb2.getPosition(), rb2.getInertiaTensorInverseW(), rb2.getRotation(), 0.0,
                                                                         m_restLength, 0.0, m_jointInfo, lambda, corr_x1, corr_q1, corr_x2, corr_q2);
...
bool DistanceConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_DistanceConstraint(x1, invMass1, x2, invMass2, m_restLength, model.getValue<Real>(SimulationModel::CLOTH_STIFFNESS),
                                                                     model.getValue<Real>(SimulationModel::CLOTH_STIFFNESS), corr1, corr2);
...
bool DihedralConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3,
...
bool DihedralConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_DihedralConstraint(x1, invMass1, x2, invMass2, x3, invMass3, x4, invMass4, m_restAngle,
                                                                     model.getValue<Real>(SimulationModel::CLOTH_BENDING_STIFFNESS), corr1, corr2, corr3, corr4);
...
//////////////////////////////////////////////////////////////////////////
bool IsometricBendingConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3,
                                                const unsigned int particle4)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
bool IsometricBendingConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr1, corr2, corr3, corr4;
    const bool res = PositionBasedDynamics::solve_IsometricBendingConstraint(x1, invMass1, x2, invMass2, x3, invMass3, x4, invMass4, m_Q,
                                                                             model.getValue<Real>(SimulationModel::CLOTH_BENDING_STIFFNESS), corr1, corr2, corr3, corr4);
...
//////////////////////////////////////////////////////////////////////////
bool FEMTriangleConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
    m_bodies[2] = particle3;
...
bool FEMTriangleConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_FEMTriangleConstraint(x1, invMass1, x2, invMass2, x3, invMass3, m_area, m_invRestMat,
                                                                        ...
                                                                        model.getValue<Real>(SimulationModel::CLOTH_POISSON_RATIO_YX), corr1, corr2, corr3);
...
//////////////////////////////////////////////////////////////////////////
bool StrainTriangleConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
    m_bodies[2] = particle3;
...
bool StrainTriangleConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr1, corr2, corr3;
    const bool res = PositionBasedDynamics::solve_StrainTriangleConstraint(x1, invMass1, x2, invMass2, x3, invMass3, m_invRestMat,
                                                                           model.getValue<Real>(SimulationModel::CLOTH_STIFFNESS_XX),
                                                                           model.getValue<Real>(SimulationModel::CLOTH_STIFFNESS_YY),
                                                                           model.getValue<Real>(SimulationModel::CLOTH_STIFFNESS_XY),
                                                                           model.getValue<bool>(SimulationModel::CLOTH_NORMALIZE_STRETCH),
                                                                           model.getValue<bool>(SimulationModel::CLOTH_NORMALIZE_SHEAR), corr1, corr2, corr3);
...
bool VolumeConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3,
                                      const unsigned int particle4)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
bool VolumeConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr1, corr2, corr3, corr4;
    const bool res = PositionBasedDynamics::solve_VolumeConstraint(x1, invMass1, x2, invMass2, x3, invMass3, x4, invMass4, m_restVolume,
                                                                   model.getValue<Real>(SimulationModel::SOLID_STIFFNESS),
                                                                   model.getValue<Real>(SimulationModel::SOLID_STIFFNESS), corr1, corr2, corr3, corr4);
...
// FEMTetConstraint
//////////////////////////////////////////////////////////////////////////
bool FEMTetConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3,
                                      const unsigned int particle4)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
bool FEMTetConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr1, corr2, corr3, corr4;
    const bool res = PositionBasedDynamics::solve_FEMTetraConstraint(x1, invMass1, x2, invMass2, x3, invMass3, x4, invMass4, m_volume, m_invRestMat,
                                                                     model.getValue<Real>(SimulationModel::SOLID_STIFFNESS),
                                                                     model.getValue<Real>(SimulationModel::SOLID_POISSON_RATIO), handleInversion, corr1, corr2, corr3,
                                                                     corr4);
...
// StrainTetConstraint
//////////////////////////////////////////////////////////////////////////
bool StrainTetConstraint::initConstraint(SimulationModel &model, const unsigned int particle1, const unsigned int particle2, const unsigned int particle3,
                                         const unsigned int particle4)
{
    m_bodies[0] = particle1;
    m_bodies[1] = particle2;
...
bool StrainTetConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr1, corr2, corr3, corr4;
    const bool res = PositionBasedDynamics::solve_StrainTetraConstraint(x1, invMass1, x2, invMass2, x3, invMass3, x4, invMass4, m_invRestMat, stiffness, stiffness,
                                                                        model.getValue<bool>(SimulationModel::SOLID_NORMALIZE_STRETCH),
                                                                        model.getValue<bool>(SimulationModel::SOLID_NORMALIZE_SHEAR), corr1, corr2, corr3, corr4);
...
//////////////////////////////////////////////////////////////////////////
bool ShapeMatchingConstraint::initConstraint(SimulationModel &model, const unsigned int particleIndices[], const unsigned int numClusters[])
{
    ParticleData &pd = model.getParticles();
...
bool ShapeMatchingConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedDynamics::solve_ShapeMatchingConstraint(m_x0, m_x, m_w, m_numberOfBodies, m_restCm, m_invRestMat,
                                                                          model.getValue<Real>(SimulationModel::SOLID_STIFFNESS), false, m_corr);
...
//////////////////////////////////////////////////////////////////////////
bool
RigidBodyContactConstraint::initConstraint(SimulationModel &model, const unsigned int rbIndex1, const unsigned int rbIndex2, const Vector3r &cp1, const Vector3r &cp2,
                                           const Vector3r &normal, const Real dist, const Real restitutionCoeff, const Real stiffness, const Real frictionCoeff)
{
    ...
    return PositionBasedRigidBodyDynamics::init_RigidBodyContactConstraint(rb1.getInvMass(), rb1.getPosition(), rb1.getVelocity(), rb1.getInertiaTensorInverseW(),
                                                                           rb1.getRotation(), rb1.getAngularVelocity(), rb2.getInvMass(), rb2.getPosition(),
                                                                           rb2.getVelocity(), rb2.getInertiaTensorInverseW(), rb2.getRotation(), rb2.getAngularVelocity(),
...
bool RigidBodyContactConstraint::solveVelocityConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_v1, corr_v2;
    Vector3r corr_omega1, corr_omega2;
    const bool res = PositionBasedRigidBodyDynamics::velocitySolve_RigidBodyContactConstraint(rb1.getInvMass(), rb1.getPosition(), rb1.getVelocity(),
                                                                                              rb1.getInertiaTensorInverseW(), rb1.getAngularVelocity(), rb2.getInvMass(),
                                                                                              rb2.getPosition(), rb2.getVelocity(), rb2.getInertiaTensorInverseW(),
                                                                                              rb2.getAngularVelocity(), m_stiffness, m_frictionCoeff, m_sum_impulses,
...
//////////////////////////////////////////////////////////////////////////
bool ParticleRigidBodyContactConstraint::initConstraint(SimulationModel &model, const unsigned int particleIndex, const unsigned int rbIndex, const Vector3r &cp1,
                                                        const Vector3r &cp2, const Vector3r &normal, const Real dist, const Real restitutionCoeff, const Real stiffness,
                                                        const Real frictionCoeff)
{
    ...
    return PositionBasedRigidBodyDynamics::init_ParticleRigidBodyContactConstraint(pd.getInvMass(particleIndex), pd.getPosition(particleIndex),
                                                                                   pd.getVelocity(particleIndex), rb.getInvMass(), rb.getPosition(), rb.getVelocity(),
                                                                                   rb.getInertiaTensorInverseW(), rb.getRotation(), rb.getAngularVelocity(), cp1, cp2,
                                                                                   normal, restitutionCoeff, m_constraintInfo);
}
...
bool ParticleRigidBodyContactConstraint::solveVelocityConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    const bool res = PositionBasedRigidBodyDynamics::velocitySolve_ParticleRigidBodyContactConstraint(pd.getInvMass(m_bodies[0]), pd.getPosition(m_bodies[0]),
                                                                                                      pd.getVelocity(m_bodies[0]), rb.getInvMass(), rb.getPosition(),
                                                                                                      rb.getVelocity(), rb.getInertiaTensorInverseW(),
                                                                                                      rb.getAngularVelocity(), m_stiffness, m_frictionCoeff,
                                                                                                      m_sum_impulses, m_constraintInfo, corr_v1, corr_v2, corr_omega2);
...
//////////////////////////////////////////////////////////////////////////
bool ParticleTetContactConstraint::initConstraint(SimulationModel &model, const unsigned int particleIndex, const unsigned int solidIndex, const unsigned int tetIndex,
                                                  const Vector3r &bary, const Vector3r &cp1, const Vector3r &cp2, const Vector3r &normal, const Real dist,
                                                  const Real frictionCoeff)
{
    m_frictionCoeff = frictionCoeff;
    ...
    return PositionBasedDynamics::init_ParticleTetContactConstraint(pd.getInvMass(particleIndex), pd.getPosition(particleIndex), pd.getVelocity(particleIndex),
                                                                    m_invMasses, m_x, m_v, bary, normal, m_constraintInfo);
}
...
bool ParticleTetContactConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr0;
    Vector3r corr[4];
    const bool res = PositionBasedDynamics::solve_ParticleTetContactConstraint(pd.getInvMass(m_bodies[0]), pd.getPosition(m_bodies[0]), m_invMasses, m_x, m_bary,
                                                                               m_constraintInfo, m_lambda, corr0, corr);
...
bool ParticleTetContactConstraint::solveVelocityConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_v0;
    Vector3r corr_v[4];
    const bool res = PositionBasedDynamics::velocitySolve_ParticleTetContactConstraint(pd.getInvMass(m_bodies[0]), pd.getPosition(m_bodies[0]),
                                                                                       pd.getVelocity(m_bodies[0]), m_invMasses, m_x, m_v, m_bary, m_lambda,
                                                                                       m_frictionCoeff, m_constraintInfo, corr_v0, corr_v);
...
bool StretchShearConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r stiffness(model.getRodShearingStiffness1(), model.getRodShearingStiffness2(), model.getRodStretchingStiffness());

    Vector3r corr1, corr2;
    Quaternionr corrq1;
    const bool res = PositionBasedCosseratRods::solve_StretchShearConstraint(x1, invMass1, x2, invMass2, q1, invMassq1, stiffness, m_restLength, corr1, corr2, corrq1);
...
bool BendTwistConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r stiffness(model.getRodBendingStiffness1(), model.getRodBendingStiffness2(), model.getRodTwistingStiffness());

    Quaternionr corr1, corr2;
    const bool res = PositionBasedCosseratRods::solve_BendTwistConstraint(q1, invMass1, q2, invMass2, stiffness, m_restDarbouxVector, corr1, corr2);
...
bool
PBD::StretchBendingTwistingConstraint::initConstraint(SimulationModel &model, const unsigned int segmentIndex1, const unsigned int segmentIndex2, const Vector3r &pos,
                                                      const Real averageRadius, const Real averageSegmentLength, Real youngsModulus, Real torsionModulus)
{
    ...
    return DirectPositionBasedSolverForStiffRods::init_StretchBendingTwistingConstraint(segment1.getPosition(), segment1.getRotation(), segment2.getPosition(),
                                                                                        segment2.getRotation(), pos, m_averageRadius, m_averageSegmentLength,
                                                                                        youngsModulus, torsionModulus, m_constraintInfo, m_stiffnessCoefficientK,
                                                                                        m_restDarbouxVector);
}

bool StretchBendingTwistingConstraint::initConstraintBeforeProjection(SimulationModel &model)
{
    DirectPositionBasedSolverForStiffRods::initBeforeProjection_StretchBendingTwistingConstraint(m_stiffnessCoefficientK,
                                                                                                 static_cast<Real>(1.0) / TimeManager::getCurrent()->getTimeStepSize(),
                                                                                                 m_averageSegmentLength, m_stretchCompliance,
                                                                                                 m_bendingAndTorsionCompliance, m_lambdaSum);
    return true;
};
...
bool StretchBendingTwistingConstraint::updateConstraint(SimulationModel &model)
{
    ...
    const RigidBody &segment1 = *rb[m_bodies[0]];
    const RigidBody &segment2 = *rb[m_bodies[1]];
    return DirectPositionBasedSolverForStiffRods::update_StretchBendingTwistingConstraint(segment1.getPosition(), segment1.getRotation(), segment2.getPosition(),
                                                                                          segment2.getRotation(), m_constraintInfo);
}
...
bool StretchBendingTwistingConstraint::solvePositionConstraint(SimulationModel &model, const unsigned int iter)
{
    ...
    Vector3r corr_x1, corr_x2;
    Quaternionr corr_q1, corr_q2;
    const bool res = DirectPositionBasedSolverForStiffRods::solve_StretchBendingTwistingConstraint(segment1.getInvMass(), segment1.getPosition(),
                                                                                                   segment1.getInertiaTensorInverseW(), segment1.getRotation(),
                                                                                                   segment2.getInvMass(), segment2.getPosition(),
                                                                                                   segment2.getInertiaTensorInverseW(), segment2.getRotation(),
                                                                                                   m_restDarbouxVector, m_averageSegmentLength, m_stretchCompliance,
                                                                                                   m_bendingAndTorsionCompliance, m_constraintInfo, corr_x1, corr_q1,
                                                                                                   corr_x2, corr_q2, m_lambdaSum);
...
bool PBD::DirectPositionBasedSolverForStiffRodsConstraint::initConstraint(SimulationModel &model,
                                                                          const std::vector<std::pair<unsigned int, unsigned int>> &constraintSegmentIndices,
                                                                          const std::vector<Vector3r> &constraintPositions, const std::vector<Real> &averageRadii,
                                                                          const std::vector<Real> &averageSegmentLengths, const std::vector<Real> &youngsModuli,
                                                                          const std::vector<Real> &torsionModuli)
{
    ...
    deleteNodes();
    DirectPositionBasedSolverForStiffRods::init_DirectPositionBasedSolverForStiffRodsConstraint(m_rodConstraints, m_rodSegments, intervals, numberOfIntervals, forward,
                                                                                                backward, root, constraintPositions, averageRadii, youngsModuli,
                                                                                                torsionModuli, m_rightHandSide, m_lambdaSums,
                                                                                                m_bendingAndTorsionJacobians, m_corr_x, m_corr_q);
...
{
    DirectPositionBasedSolverForStiffRods::initBeforeProjection_DirectPositionBasedSolverForStiffRodsConstraint(m_rodConstraints, static_cast<Real>(1.0) /
                                                                                                                                  TimeManager::getCurrent()->getTimeStepSize(),
                                                                                                                m_lambdaSums);
    return true;
}
...
{
    const bool res = DirectPositionBasedSolverForStiffRods::solve_DirectPositionBasedSolverForStiffRodsConstraint(m_rodConstraints, m_rodSegments, intervals,
                                                                                                                  numberOfIntervals, forward, backward, m_rightHandSide,
                                                                                                                  m_lambdaSums, m_bendingAndTorsionJacobians, m_corr_x,
                                                                                                                  m_corr_q);
