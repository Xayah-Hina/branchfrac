...
namespace PBD
{
    ...
    private:
        ...
        static void
        computeMatrixK(const Vector3r &connector0, const Vector3r &connector1, const Real invMass, const Vector3r &x, const Matrix3r &inertiaInverseW, Matrix3r &K);
    ...
    public:
        ...
        */
        static bool solve_BallJoint(const Real invMass0,                            // inverse mass is zero if body is static
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_BallOnLineJoint(const Real invMass0,                            // inverse mass is zero if body is static
                                          const Vector3r &x0,                        // center of mass of body 0
                                          const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                          const Quaternionr &q0,                    // rotation of body 0
                                          const Real invMass1,                            // inverse mass is zero if body is static
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_HingeJoint(const Real invMass0,                            //inverse  mass is zero if body is static
                                     const Vector3r &x0,                        // center of mass of body 0
                                     const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                     const Quaternionr &q0,                    // rotation of body 0
                                     const Real invMass1,                            // inverse mass is zero if body is static
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_UniversalJoint(const Real invMass0,                            // inverse mass is zero if body is static
                                         const Vector3r &x0,                        // center of mass of body 0
                                         const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                         const Quaternionr &q0,                    // rotation of body 0
                                         const Real invMass1,                            // inverse mass is zero if body is static
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_SliderJoint(const Real invMass0,                            //inverse  mass is zero if body is static
                                      const Vector3r &x0,                        // center of mass of body 0
                                      const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                      const Quaternionr &q0,                    // rotation of body 0
                                      const Real invMass1,                            // inverse mass is zero if body is static
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_TargetPositionMotorSliderJoint(const Real invMass0,                            //inverse  mass is zero if body is static
                                                         const Vector3r &x0,                        // center of mass of body 0
                                                         const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                                         const Quaternionr &q0,                    // rotation of body 0
                                                         const Real invMass1,                            // inverse mass is zero if body is static
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_TargetVelocityMotorSliderJoint(const Real invMass0,                            //inverse  mass is zero if body is static
                                                         const Vector3r &x0,                        // center of mass of body 0
                                                         const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                                         const Quaternionr &q0,                    // rotation of body 0
                                                         const Real invMass1,                            // inverse mass is zero if body is static
        ...
        */
        static bool velocitySolve_TargetVelocityMotorSliderJoint(const Real invMass0,                            //inverse  mass is zero if body is static
                                                                 const Vector3r &x0,                        // center of mass of body 0
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_TargetAngleMotorHingeJoint(const Real invMass0,                            //inverse  mass is zero if body is static
                                                     const Vector3r &x0,                        // center of mass of body 0
                                                     const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                                     const Quaternionr &q0,                    // rotation of body 0
                                                     const Real invMass1,                            // inverse mass is zero if body is static
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_TargetVelocityMotorHingeJoint(const Real invMass0,                            // inverse  mass is zero if body is static
                                                        const Vector3r &x0,                        // center of mass of body 0
                                                        const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                                        const Quaternionr &q0,                    // rotation of body 0
                                                        const Real invMass1,                            // inverse mass is zero if body is static
        ...
        * @param corr_omega1 angular velocity correction of second body
        */
        static bool velocitySolve_TargetVelocityMotorHingeJoint(const Real invMass0,                            //inverse  mass is zero if body is static
                                                                const Vector3r &x0,                        // center of mass of body 0
                                                                const Vector3r &v0,                        // velocity of body 0
                                                                const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                                                const Vector3r &omega0,
        ...
        */
        static bool solve_RigidBodyParticleBallJoint(const Real invMass0,                            // inverse mass is zero if body is static
                                                     const Vector3r &x0,                        // center of mass of body 0
                                                     const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                                     const Quaternionr &q0,                    // rotation of body 0
        ...
        */
        static bool init_RigidBodyContactConstraint(const Real invMass0,                            // inverse mass is zero if body is static
                                                    const Vector3r &x0,                        // center of mass of body 0
                                                    const Vector3r &v0,                        // velocity of body 0
                                                    const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                                    const Quaternionr &q0,                    // rotation of body 0
        ...
        * 2,4:  goal velocity in normal direction after collision
        */
        static bool init_ParticleRigidBodyContactConstraint(const Real invMass0,                            // inverse mass is zero if body is static
                                                            const Vector3r &x0,                        // center of mass of body 0
                                                            const Vector3r &v0,                        // velocity of body 0
                                                            const Real invMass1,                            // inverse mass is zero if body is static
                                                            const Vector3r &x1,                        // center of mass of body 1
        ...
        * @param corr_omega1 angular velocity correction of second body
        */
        static bool velocitySolve_ParticleRigidBodyContactConstraint(const Real invMass0,                            // inverse mass is zero if body is static
                                                                     const Vector3r &x0,                        // center of mass of body 0
                                                                     const Vector3r &v0,                        // velocity of body 0
                                                                     const Real invMass1,                            // inverse mass is zero if body is static
                                                                     const Vector3r &x1,                        // center of mass of body 1
        ...
        */
        static bool init_DistanceJoint(const Vector3r &x0,                        // center of mass of body 0
                                       ...
                                       const Vector3r &x1,                        // center of mass of body 1
                                       const Quaternionr &q1,                    // rotation of body 1
                                       const Vector3r &pos0, const Vector3r &pos1, Eigen::Matrix<Real, 3, 4, Eigen::DontAlign> &jointInfo);
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_DistanceJoint(const Real invMass0,                            // inverse mass is zero if body is static
                                        const Vector3r &x0,                        // center of mass of body 0
                                        const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                        const Quaternionr &q0,                    // rotation of body 0
                                        const Real invMass1,                            // inverse mass is zero if body is static
                                        ...
                                        const Matrix3r &inertiaInverseW1,        // inverse inertia tensor (world space) of body 1
                                        const Quaternionr &q1,                    // rotation of body 1
                                        const Real stiffness, const Real restLength, const Real dt,
                                        const Eigen::Matrix<Real, 3, 4, Eigen::DontAlign> &jointInfo,    // precomputed joint info
                                        Real &lambda, Vector3r &corr_x0, Quaternionr &corr_q0, Vector3r &corr_x1, Quaternionr &corr_q1);
        ...
        * @param corr_q1 rotation correction of second body
        */
        static bool solve_DamperJoint(const Real invMass0,                            //inverse  mass is zero if body is static
                                      const Vector3r &x0,                        // center of mass of body 0
                                      const Matrix3r &inertiaInverseW0,        // inverse inertia tensor (world space) of body 0
                                      const Quaternionr &q0,                    // rotation of body 0
                                      const Real invMass1,                            // inverse mass is zero if body is static
                                      ...
                                      const Matrix3r &inertiaInverseW1,        // inverse inertia tensor (world space) of body 1
                                      const Quaternionr &q1,                    // rotation of body 1
                                      const Real stiffness, const Real dt,
                                      const Eigen::Matrix<Real, 4, 6, Eigen::DontAlign> &jointInfo,    // precomputed slider joint info
                                      Real &lambda, Vector3r &corr_x0, Quaternionr &corr_q0, Vector3r &corr_x1, Quaternionr &corr_q1);
    };
}
